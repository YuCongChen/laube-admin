...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/laube/workspace/laube/laube-admin/prisma/client/mysql",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/laube/workspace/laube/laube-admin/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchemaHash": "87547202aa7a311348fb9274412c34b3b8a506c060f86a4059b6faecd236dbe3",
  "copyEngine": true
}
...
path.join(process.cwd(), "prisma/client/mysql/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/client/mysql/schema.prisma")
